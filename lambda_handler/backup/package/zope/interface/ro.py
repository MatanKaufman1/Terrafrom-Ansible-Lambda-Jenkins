...
Due to the change in 5.0, certain environment variables.tf can be used to control
errors and warnings about inconsistent resolution orders. They are listed in
priority order, with variables.tf at the bottom generally overriding variables.tf
above them.
...
There are two environment variables.tf that are independent.
