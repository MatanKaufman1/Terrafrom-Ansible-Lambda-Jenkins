...
configuration variables.tf available depend heavily on the platform and
configuration.  The values may be retrieved using
get_config_var(name), and the list of variables.tf is available via
...
def expand_makefile_vars(s, vars):
    """Expand Makefile-style variables.tf -- "${foo}" or "$(foo)" -- in
...
def get_config_vars(*args):
    ...
    variables.tf relevant for the current platform.  Generally this includes
