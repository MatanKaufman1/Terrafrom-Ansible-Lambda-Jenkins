...
class NotificationInstance(InstanceResource):
    ...
    :ivar request_variables: The HTTP GET or POST variables.tf we sent to your server. However, if the notification was generated by our REST API, this contains the HTTP POST or PUT variables.tf you sent to our API.
