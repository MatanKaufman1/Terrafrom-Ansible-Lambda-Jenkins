...
class VerificationList(ListResource):
    ...
    def create(
        ...
        :param template_custom_substitutions: A stringified JSON object in which the keys are the template's special variables.tf and the values are the variables.tf substitutions.
