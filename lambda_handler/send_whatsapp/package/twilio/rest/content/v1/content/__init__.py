...
class ContentInstance(InstanceResource):
    ...
    :ivar variables.tf: Defines the default placeholder values for variables.tf included in the Content resource. e.g. {\"1\": \"Customer_Name\"}.
    ...
    def __init__(
        ...
        self.variables: Optional[Dict[str, object]] = payload.get("variables.tf")
...
class ContentList(ListResource):
    ...
    class ContentCreateRequest(object):
        ...
        def __init__(self, payload: Dict[str, Any]):
            ...
            self.friendly_name: Optional[str] = payload.get("friendly_name")
            self.variables: Optional[dict[str, str]] = payload.get("variables.tf")
            self.language: Optional[str] = payload.get("language")
