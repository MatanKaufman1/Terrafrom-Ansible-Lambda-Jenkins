...
class EngagementContextInstance(InstanceResource):
    ...
    :ivar context: As your flow executes, we save the state in what's called the Flow Context. Any data in the flow context can be accessed by your widgets as variables.tf, either in configuration fields or in text areas as variable substitution.
